---
title: "Central Limit Theorem - P1"
...
#Reading the hospital datasheet
...
```
#Insight corner: Most patients are discharged in less than 5 days, the distributed is right-skewed
```{r}
set.seed(123)
sampleMeanSize2 <- c()
sampleMeanSize10 <- c()
